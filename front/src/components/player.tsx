...
import { TbMusic, TbPlayerPause, TbPlayerSkipBack, TbPlayerSkipForward } from "react-icons/tb";
...
const Player = () => {
  ...
  return (
    <div className="fixed w-screen bottom-0 inset-x-0 h-24">
      <div className="py-3 bg-gray-900/70  text-gray-100">
            ...
            <div className="flex items-center justify-center gap-3 lg:w-2/12">
              ...
              <button
                ...
                {currentMusic.isPlaying ? (
                  <TbPlayerPause size={26} className="fill-pink-500 m-1" />
                ) : (
